        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    {
                        method: 'GET',
                        headers: new node_fetch_1.Headers(exports.defaultHeaders)
                    }, 
                    // override init params
                    init, 
                    // ensure default headers is exist but not replaced
                    {
                        headers: new node_fetch_1.Headers(Object.assign({}, exports.defaultHeaders, init.headers))
                    });
                    ...
                    console.info('Request: %j \nBody: %j', Object.assign({ url: url }, init), init.body);
...
function get(url, params, credential, useJwt, useBasicAuth) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            if (useBasicAuth) {
                headers.set('Authorization', "Basic " + Buffer.from(credential.apiKey + ':' + credential.apiSecret).toString('base64'));
            }
