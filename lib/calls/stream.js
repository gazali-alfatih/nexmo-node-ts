...
exports.NexmoStreamEndPoint = new endpoint_1.default('api.nexmo.com', '/v1/calls/{{uuid}}/stream');
var NexmoStream = /** @class */ (function () {
    function NexmoStream(credential, options) {
        this.credential = credential;
        this.options = Object.assign({ retry: true, limit: 10 }, options);
    }
    Object.defineProperty(NexmoStream, "ENDPOINT", {
        get: function () {
            return exports.NexmoStreamEndPoint;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NexmoStream, "RETRYPATHS", {
        get: function () {
    ...
    NexmoStream.prototype.start = function (callsId, params, retry) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        body = JSON.stringify(Object.assign({ loop: 1, level: 0 }, params));
                        url = NexmoStream.ENDPOINT.deserialize([
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.start(callsId, params, retry + 1)];
    ...
    NexmoStream.prototype.stop = function (callsId, retry) {
        if (retry === void 0) { retry = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var url, res, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        // throw error when try limit is exceed
                        if (retry + 1 >= this.options.limit) {
                            throw new Error(err_2.message || err_2);
                        }
                        if (!this.options.retry) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.stop(callsId, retry + 1)];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4: 
                    // throw err when all condition is not match
                    throw err_2;
...
exports.NexmoStream = NexmoStream;
exports.default = NexmoStream;
