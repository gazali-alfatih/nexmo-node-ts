...
exports.NexmoTalkEndPoint = new endpoint_1.default('api.nexmo.com', '/v1/calls/{{uuid}}/talk');
var NexmoTalk = /** @class */ (function () {
    function NexmoTalk(credential, options) {
        this.credential = credential;
        this.options = Object.assign({ retry: true, limit: 10 }, options);
    }
    Object.defineProperty(NexmoTalk, "ENDPOINT", {
        get: function () {
            return exports.NexmoTalkEndPoint;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(NexmoTalk, "RETRYPATHS", {
        get: function () {
    ...
    NexmoTalk.prototype.start = function (callsId, params, retry) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        body = JSON.stringify(Object.assign({ voice_name: 'Kimberly', loop: 1, level: 0 }, params));
                        url = NexmoTalk.ENDPOINT.deserialize([
    ...
    NexmoTalk.prototype.stop = function (callsId, retry) {
        if (retry === void 0) { retry = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var url, res, err_2;
            return __generator(this, function (_a) {
...
exports.NexmoTalk = NexmoTalk;
exports.default = NexmoTalk;
