...
exports.NexmoCallsEndPoint = new endpoint_1.default('api.nexmo.com', '/v1/calls');
var NexmoCalls = /** @class */ (function () {
    ...
    Object.defineProperty(NexmoCalls, "ENDPOINT", {
        get: function () {
            return exports.NexmoCallsEndPoint;
        },
        enumerable: true,
        configurable: true
    });
    ...
    NexmoCalls.prototype.get = function (query, retry) {
        if (retry === void 0) { retry = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var pathExt, url, res, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 5]);
                        ...
                        NexmoCalls.ENDPOINT.host =
                            NexmoCalls.RETRYPATHS[retry % dtmf_1.default.RETRYPATHS.length];
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.get(query, retry + 1)];
    ...
    NexmoCalls.prototype.update = function (callsId, params, retry) {
        if (retry === void 0) { retry = 0; }
        return __awaiter(this, void 0, void 0, function () {
            var body, url, res, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 5]);
                    ...
                    case 2:
                        ...
                        if (!this.options.retry) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.update(callsId, params, retry + 1)];
                    case 3: return [2 /*return*/, _a.sent()];
                    case 4: 
                    // throw err when all condition is not match
                    throw err_2;
