...
var NexmoDtmf = /** @class */ (function () {
    ...
    Object.defineProperty(NexmoDtmf, "ENDPOINT", {
        get: function () {
            return new endpoint_1.default('api.nexmo.com', '/v1/calls/{{uuid}}/dtmf');
        },
        enumerable: true,
        configurable: true
    });
    ...
    NexmoDtmf.prototype.send = function (callId, params, retry) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (retry > 0) {
                            url.replace(NexmoDtmf.ENDPOINT.path, NexmoDtmf.RETRYPATHS[retry % NexmoDtmf.RETRYPATHS.length]);
                        }
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.send(callId, params, retry + 1)];
